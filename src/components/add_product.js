                ...
                <div className="flex-form">
                   <div>
                        ...
                        <div className="sizing">
                            ...
                            <input onFocus={inputFoucs} onBlur={inputBlur} type="number" name="qty" id="qty" onChange={(e) => setQty(qty + Number( e.target.value)) }/>
                        </div> 

                        <div className="sizing">
                            <label htmlFor="price">Price</label>
                            <input onFocus={inputFoucs} onBlur={inputBlur} type="number" name="price" id="price" onChange={(e) => setPrice(price + Number(e.target.value))}/> 
                        </div>   
                        ...
                        {/* <div className="sizing">
                            <input onFocus={inputFoucs} onBlur={inputBlur} type="file" multiple name="slider" ref={fileInput2} onChange={(e) => setMultipleCovers(multipleCovers = e.target.files)}/>
                            <label htmlFor="" onClick={() => {fileInput2.current.click()}} style={{cursor:'pointer'}}>Multiple Covers</label>
                        </div>   */}
