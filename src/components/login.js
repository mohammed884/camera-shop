...
export default function Login() {
    ...
    useEffect(() =>
    {
        fetch('http://localhost:8000/user', {
          ...
          .then((res) => res.json())
          .then(res => {
                if (res.isLogin) history.push('/home');
    ...
    function handleSubmit(e)
    {
        ...
        .then(res => res.json())
        .then(res => {res.done === true ? history.push('home') : setMsg(res.msg)})
        .catch(err => console.log(err))
    }
                ...
                <form onSubmit={handleSubmit} className="login-form">
                    ...
                    <div>{msg}
                        <div className="sizing">
                            ...
                            <input onFocus={inputFoucs} onBlur={inputBlur} onChange={(e) => setEmail(email = e.target.value)} type="email" id="email" name="email"/>
                        </div>

                        <div className="sizing">
                            <label htmlFor="password">Password</label>
                            <input onFocus={inputFoucs} onBlur={inputBlur} onChange={(e) => setPassword(password = e.target.value)} type="password" id="password" name="password"/>
                        </div>
